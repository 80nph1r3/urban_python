...
users_num = cursor.execute("select count(*) from Users").fetchone()[0]
balance_sum = cursor.execute("select sum(balance) from Users").fetchone()[0]
print(balance_sum / users_num)
